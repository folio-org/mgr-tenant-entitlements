package org.folio.entitlement.integration.kong.model.expression;

import static java.util.Objects.requireNonNull;
import static org.apache.commons.lang3.StringUtils.replace;
import static org.folio.entitlement.integration.kong.model.expression.IntExpressionBuilder.NET_DST_PORT_FIELD;
import static org.folio.entitlement.integration.kong.model.expression.IntExpressionBuilder.NET_PORT_FIELD;
import static org.folio.entitlement.integration.kong.model.expression.IntExpressionBuilder.NET_SRC_PORT_FIELD;
import static org.folio.entitlement.integration.kong.model.expression.IpAddrExpressionBuilder.NET_DST_IP_FIELD;
import static org.folio.entitlement.integration.kong.model.expression.IpAddrExpressionBuilder.NET_SRC_IP_FIELD;
import static org.folio.entitlement.integration.kong.model.expression.StringExpressionBuilder.HTTP_HEADERS_FIELD_PREFIX;
import static org.folio.entitlement.integration.kong.model.expression.StringExpressionBuilder.HTTP_METHOD_FIELD;
import static org.folio.entitlement.integration.kong.model.expression.StringExpressionBuilder.HTTP_PATH_FIELD;
import static org.folio.entitlement.integration.kong.model.expression.StringExpressionBuilder.HTTP_QUERIES_FIELD_PREFIX;
import static org.folio.entitlement.integration.kong.model.expression.StringExpressionBuilder.NET_PROTOCOL_FIELD;
import static org.folio.entitlement.integration.kong.model.expression.StringExpressionBuilder.TLS_SNI_FIELD;
import static org.folio.entitlement.integration.kong.model.operator.BoolOperator.AND;
import static org.folio.entitlement.integration.kong.model.operator.BoolOperator.OR;
...
import org.folio.entitlement.integration.kong.model.operator.BoolOperator;
