 ...
 * from Keycloak for requests to mgr-tenants. This prevents token expiration issues
 * during long-running operations.
 */
@Log4j2
@RequiredArgsConstructor
public class TenantManagerRequestInterceptor implements RequestInterceptor {
  ...
  public void apply(RequestTemplate template) {
    ...
    if (tokenHeaders != null && !tokenHeaders.isEmpty()) {
      ...
      log.debug("Replaced token for mgr-tenants request");
    }
  }
}
