...
class ApplicationManagerRequestInterceptorTest {

  private static final String FRESH_TOKEN = "fresh-token";

  @Mock private TokenProvider tokenProvider;

  private ApplicationManagerRequestInterceptor interceptor;

  @BeforeEach
  void setUp() {
    interceptor = new ApplicationManagerRequestInterceptor(tokenProvider);
  }
