...
class LegacyGatewayPropertiesIT extends BaseIntegrationTest {
  ...
  void apiGatewayIntegration_positive_legacyPropertiesAreSupported() {
    ...
    assertThat(startupLogs).contains("Configuration property 'application.kong.connect-timeout' is deprecated and "
      + "will be removed in the Vetch release. Use 'application.apigw.connect-timeout' instead.");
  }
