...
class EntitlementFlowInitializerTest {

  @InjectMocks private EntitlementFlowInitializer entitlementFlowInitializer;
  ...
  void execute_positive() {
    ...
    entitlementFlowInitializer.execute(stageContext);
